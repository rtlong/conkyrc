...
#
# For the signature, it will randomly select a font from the list provided. This keeps the
# signatures looking a little bit fresher and less like they were generated by a computer.
#
...
def random_font
  @selected_font ||= FONTS.keys[rand(FONTS.size)]
...
if fortune[2] #and fortune[2] != "Unknown" # uncomment this to see no signature instead of "Unknown"
  ...
  out << [random_font, fortune[2], '${font}'].join
end
